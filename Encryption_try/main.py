...
from PyQt5.QtCore import QTimer, QPropertyAnimation, QEasingCurve, QDateTime, Qt
from PyQt5.QtWidgets import QMainWindow,QLabel, QWidget, QApplication, QVBoxLayout, QSlider, QDateTimeEdit
...
os.system("pyuic5 -o startwindow_ui.py startwindow.ui")
...
###################################################
from startwindow_ui import *


####################################################
# Start Stablish Connection WINDOW CLASS
####################################################
...
class startwindow(QMainWindow):
    def __init__(self, parent=None):
        ...
        # Once connection is established, close this window and open the main window
        ...
        self.ui1.pushButton.clicked.connect(self.open_next_window)
        ############################### Call the Conect func ###############
        self.establish_connection()

###################################################################################
################################### <== Security to open the dashboard ############
###################################################################################
...
################ Function for the update dots ############
    def update_text(self):
        self.dot_count = (self.dot_count + 1) % 4
        self.ui1.label.setText('Connecting' + '.' * self.dot_count)

################ Function to open the dashboard from the button ############
